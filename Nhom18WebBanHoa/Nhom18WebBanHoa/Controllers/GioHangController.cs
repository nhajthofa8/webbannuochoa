...
namespace Nhom18WebBanHoa.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult DatHang(string ten, string SDT, string email, string diachi, string tieude)
        {
            ...
            MailMessage mail = new MailMessage("huynhnhathoa10082001@gmail.com", email, "Thông tin đơn hàng", tb);
            SmtpClient client = new SmtpClient("smtp.gmail.com", 587);
            client.EnableSsl = true;
            client.Credentials = new NetworkCredential("huynhnhathoa10082001", "0972138927Az");
